    ...
    return (
        <div className="pt-20">
            <div className="flex gap-3 px-30">
                {['Breakfast', 'Dinner', 'Lunch'].map((meal) => (
                    <button
                        key={meal}
                ...
                <div className="mt-5">
                    ...
                    <div className="bg-gray-50 pt-1 mx-10 rounded">
                        <form className="flex flex-col gap-4 mt-2 px-30">
                            <div>
                                <label className="text-2xl font-semibold">Update Breakfast Meal Availability</label>
                            ...
                            <div className='flex flex-col gap-2'>
                                ...
                                <div className='grid grid-cols-2 gap-4'>
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-lg font-semibold'> Enter Details for a New Large Breakfast Item</h1>
                                        <label className="text-lg">Food Item Name</label>
                                        <input
                                            type="text"
                                            placeholder="Add Breakfast Item"
                                    ...
                                    <div>
                                        <label className="text-lg">Name of Food Item</label>
                                        <input
                                            type="text"
                                            placeholder="Add Breakfast Item"
                                            className="border border-gray-300 rounded p-2 w-full focus:outline-none focus:ring-0 focus:border-[#4CCF7E] transition-colors duration-200"
                                    ...
                                    <div>
                                        <label className="text-lg">Portion of Food Item</label>
                                        <input
                                            type="text"
                                            placeholder="Add Breakfast Item"
                                            className="border border-gray-300 rounded p-2 w-full focus:outline-none focus:ring-0 focus:border-[#4CCF7E] transition-colors duration-200"
