...
function Beverages (){
    ...
    return(
        ...
        <NavBar />
            <div className="pt-20">
                <h2 className="text-3xl font-bold px-30">Beverages Menu</h2>
                <p className="text-2xl text-gray-500 px-30 mb-2">Add and Manage Beverage Items from Here</p>
                ...
                <div className="bg-gray-100 pt-1 mx-20 rounded-4xl">
                    <form className="flex flex-col gap-4 mt-2 px-30">
                        ...
                        <div className='flex flex-col gap-2'>
                            <label className="text-2xl font-semibold mt-2">Add Items to Beverages Menu

                            </label>
                            <h1 className='text-lg font-semibold'> Build a New Beverage – Enter Beverage Details</h1>
                            <div>

                                    
                                    <label className="text-lg">Upload Beverage Image</label>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        placeholder="E.g. Falooda, Iced Coffee"
                    ...
                    <label className="text-2xl font-semibold px-30">Remove Beverage Item
                            ...
                            <tbody>
                                {data.map((item, index) => (
                                    <tr key={item.id} className="text-center">
                                        ...
                                        <td className="border border-gray-400 px-2 py-1 text-left">{item.col1}</td>
