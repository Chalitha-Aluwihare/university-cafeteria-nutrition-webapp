...
function CategoryItem() {
  ...
  return (
    <div className="ml-3 mt-2 flex gap-2">
      <button onClick={() => setActive(1)} className={`rounded-[21px] w-[113px] h-[170px] ${active === 1 ? 'bg-[#3FC660]' : 'bg-[#F8F6F7]'}`}>
      ...
      <button onClick={() => setActive(2)} className={`rounded-[21px] w-[113px] h-[170px] ${active === 2 ? 'bg-[#3FC660]' : 'bg-[#F8F6F7]'}`}>
      ...
      <button onClick={() => setActive(3)} className={`rounded-[21px] w-[113px] h-[170px] ${active === 3 ? 'bg-[#3FC660]' : 'bg-[#F8F6F7]'}`}>
